...
class Interface(wx.Frame):
    ...
    def montarEstruturaDoPainel(Self):
        ...
        Self.Texto_estatico_preco = wx.StaticText(painel, label="Digite o preço total do produto no formato real.Centavo:")
        Self.formula_preco = wx.TextCtrl(painel, -1, name="Digite o preço total do produto no formato real.centavo:")
        ...
        Self.texto_estatico_porcentagem = wx.StaticText(painel, label="Digite a porcentagem que será a base para o seu lucro:")
        Self.formula_porcentagem = IntCtrl(painel, -1, name="Digite a porcentagem que será a base para o seu lucro:")
        botao_adicionar_produto = wx.Button(painel, wx.ID_OK, label="Adicionar produto")
        botao_cancelar = wx.Button(painel, wx.ID_CANCEL, label="Cancelar a adiçao deste produto")
